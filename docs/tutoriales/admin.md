...
No cambias turnos (eso es del gerente). Usuario: `ADMIN-Z1` … `ADMIN-Z5`.
...
Quién hizo qué y cuándo en tus tiendas (hora de México). Filtra por **Qué** o **Quién** y descárgalo en CSV.

![Historial](img/a03_historial.png)

## 4. Horario de cualquier tienda
